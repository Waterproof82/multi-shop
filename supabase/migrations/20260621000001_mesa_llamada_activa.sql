-- Add llamada_activa to mesa_sesiones for client-to-waiter call feature.

ALTER TABLE public.mesa_sesiones
  ADD COLUMN IF NOT EXISTS llamada_activa BOOLEAN NOT NULL DEFAULT false;

-- Rebuild get_mesas_with_sessions to include llamada_activa.
