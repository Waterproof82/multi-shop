      ...
      <div className="bg-primary rounded-lg p-4 sm:p-6" suppressHydrationWarning>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" suppressHydrationWarning>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4" suppressHydrationWarning>
            <div 
              className="bg-primary-foreground/20 rounded-lg px-4 py-3 text-center min-h-[72px] flex flex-col justify-center group hover:bg-primary-foreground/30 transition-[background-color,transform] duration-150 hover:scale-[1.02] motion-reduce:hover:scale-100 hover:shadow-elegant" 
            ...
            >
              ...
              <span className="text-xl font-semibold text-primary-foreground" aria-live="polite">{stats?.pedidosHoy || 0}</span>
            ...
            >
              <span suppressHydrationWarning className="text-xl font-semibold text-primary-foreground" aria-live="polite">{formatPrice(stats?.totalMes || 0, 'EUR', language)}</span>
            ...
            >
              ...
              <span className="text-xl font-semibold text-primary-foreground" aria-live="polite">{totalProductos}</span>
            ...
            >
              <span className="text-xl font-semibold text-primary-foreground" aria-live="polite">{productosEspeciales}</span>
