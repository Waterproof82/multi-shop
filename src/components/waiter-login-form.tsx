            ...
            return (
              ...
              >
                ...
                <div className="absolute top-3 right-3">
                  {isAmber ? (
                    <span className="block h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "oklch(70% 0.19 62)" }} />
                  ) : isOpen ? (
                ...
                <div className="flex flex-col items-center gap-1 flex-1 justify-center">
                  <UtensilsCrossed
                    ...
                    style={{ color: isAmber ? "oklch(65% 0.16 62)" : isOpen ? "oklch(65% 0.16 148)" : "oklch(42% 0.06 252)" }}
                  />
                  <span
                    className="text-3xl font-black leading-none tracking-tight"
                    style={{ color: isAmber ? "oklch(92% 0.04 62)" : isOpen ? "oklch(92% 0.04 148)" : "oklch(80% 0.03 252)" }}
                  >
                  ...
                  {mesa.nombre && (
                    <span
                      ...
                      style={{ color: isAmber ? "oklch(60% 0.10 62)" : isOpen ? "oklch(60% 0.10 148)" : "oklch(48% 0.05 252)" }}
                    >
                      {mesa.nombre}
                    </span>
                  )}
