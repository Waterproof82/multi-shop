...
function generateOrderEmail(items: CartItem[], total: number, empresaNombre: string): string {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          <tr style="background-color: #1a1a1a;">
            <td style="padding: 24px; text-align: center;">
              ...
              <p style="margin: 8px 0 0 0; color: #888; font-size: 14px;">Nuevo Pedido Confirmado</p>
            </td>
          </tr>
          <tr>
...
export async function POST(request: Request) {
  try {
    ...
    const html = generateOrderEmail(items, total, empresa.nombre);
