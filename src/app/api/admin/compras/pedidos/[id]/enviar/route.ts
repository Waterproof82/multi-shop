...
import { sendPedidoUseCase } from '@/core/application/use-cases/compras/pedido/sendPedido.use-case';
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await sendPedidoUseCase(getComprasRepository(), ctx.empresaId, id);
