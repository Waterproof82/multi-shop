              ...
              {ranking.slice(0, 10).map((emp) => (
                <div key={emp.empresaId} className="flex items-center gap-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                    emp.posicion === 1 ? 'bg-yellow-100 text-yellow-700' :
                    emp.posicion === 2 ? 'bg-gray-100 text-gray-700' :
                    emp.posicion === 3 ? 'bg-orange-100 text-orange-700' :
                ...
                {empresas.map((empresa) => (
                  <tr key={empresa.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-4 py-4 text-center">
                      <span className="text-sm font-medium text-green-600">{empresa.stats.pedidosHoy}</span>
                    </td>
                    <td className="px-4 py-4 text-center">
                      <span className="text-sm font-medium text-blue-600">{empresa.stats.pedidosMes}</span>
                    </td>
                    ...
                    <td className="px-4 py-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] px-4 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors"
                      >
                        Editar
                      </Link>
                    </td>
