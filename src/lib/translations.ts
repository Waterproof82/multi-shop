...
export const translations = {
  es: {
    ...
    orderReceivedMessage: "Nos pondremos en contacto para finalizar el pedido.",
  ...
  en: {
    ...
    orderReceivedMessage: "Thank you for your order. We will contact you to finalize the process.",
  ...
  fr: {
    ...
    orderReceivedMessage: "Merci pour votre commande. Nous vous contacterons pour finaliser le processus.",
  ...
  it: {
    ...
    orderReceivedMessage: "Grazie per il tuo ordine. Ti contatteremo per finalizzare il processo.",
  ...
  de: {
    ...
    orderReceivedMessage: "Vielen Dank fur Ihre Bestellung. Wir werden Sie kontaktieren, um den Prozess abzuschliessen.",
