...
- [x] **Step 1: Verificar en vivo si hay filas `recogida` con precio > 0 (antes de escribir el backfill)**
...
- [x] **Step 3: Aplicar con `supabase db push --linked` (nunca MCP suelto) y verificar**
...
- [x] **Step 1: Leer el archivo de test existente para ver el patrón de tests ya usado**

```bash
head -30 tests/core/modalidad-entrega-dto.test.ts
```

- [x] **Step 2: Agregar el test que falla primero**
...
- [x] **Step 3: Ejecutar y verificar que el primer test falla**
...
- [x] **Step 4: Extender el `.superRefine()` existente en `modalidad-entrega.dto.ts`**
...
- [x] **Step 5: `ModalidadesEntregaForm.tsx` usa el módulo compartido en vez de su copia local**
...
- [x] **Step 6: Ejecutar la suite de ese componente y confirmar que sigue verde**
...
- [x] **Step 7: `pnpm lint && pnpm typecheck`**
...
- [x] **Step 1: Actualizar el test existente que llenaba el campo de precio para recogida**
...
- [x] **Step 2: Ejecutar y verificar que fallan las 2 nuevas (la primera ya pasaba antes del cambio, ahora falla distinto)**

Run: `npx vitest run tests/ui/modalidades-entrega-form.test.tsx`
Expected: FAIL en `'el formulario de tipo recogida NO muestra el input de precio'` (el input hoy siempre se renderiza).

- [x] **Step 3: Ocultar el input de precio para tipo recogida en `ModalidadesEntregaForm.tsx`**
...
- [x] **Step 4: Ejecutar y verificar que toda la suite pasa**
...
- [x] **Step 1: Agregar la clave de traducción `tiendaGratisLabel` en los 5 idiomas de `src/lib/translations.ts`**
...
- [x] **Step 2: Escribir los tests que fallan primero**
...
- [x] **Step 3: Ejecutar y verificar que los 3 tests nuevos fallan**
...
- [x] **Step 4: Reescribir `TiendaFulfillmentSelector.tsx`**
...
- [x] **Step 5: Ejecutar y verificar que toda la suite pasa**

Run: `npx vitest run tests/ui/tienda-fulfillment-selector.test.tsx`
Expected: PASS — 11 tests (8 existentes + 3 nuevos).

- [x] **Step 6: Correr también la suite del carrito completo, por si algún test ahí dependía del layout viejo de recogida**
...
- [x] **Step 1: `cart-drawer-wizard-tienda.test.tsx` — cambiar los 2 fixtures de recogida-con-precio a domicilio**
...
- [x] **Step 2: `pedido-modalidad-revalidacion.test.ts` — fixture de recogida con precio 150**
...
- [x] **Step 3: Ejecutar ambos archivos y verificar que pasan**
...
- [x] **Step 1: `TiendaDeliverySettings.tsx` — labels de los toggles y encabezados**
...
- [x] **Step 2: `ModalidadesEntregaForm.tsx` — nombre de la modalidad sin color de texto**
...
- [x] **Step 3: Correr la suite de ambos componentes**
...
- [x] **Step 5: `pnpm lint && pnpm typecheck`**
...
- [x] **Step 2: `pnpm db:smoke`**

Expected: exit 0.

- [x] **Step 3: Verificación en vivo en el navegador**
...
- [x] **Step 4: Actualizar el plan original con una nota de seguimiento**
...
- [x] **Step 5: Commit final si quedó algo pendiente de las verificaciones**
